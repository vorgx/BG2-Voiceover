"""
Build Dryad voice reference from selected BG2 audio clips.
Forest spirit NPC.
"""
import wave
...
OUTPUT = ROOT / "refs" / "dryad_ref.wav"
...
def main():
    print("🎤 Building Dryad Voice Reference")
    ...
    print(f"\n✅ Dryad reference ready at: refs/dryad_ref.wav")
